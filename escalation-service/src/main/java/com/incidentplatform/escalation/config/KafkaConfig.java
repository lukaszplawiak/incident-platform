...
public class KafkaConfig {
    ...
    private final String escalationDeadLetterTopic;
    ...
    public KafkaConfig(
            ...
            @Value("${kafka.topics.escalation-dead-letter:escalation.dead-letter}")
            String escalationDeadLetterTopic,
            @Value("${kafka.dead-letter.retention-days:30}") int deadLetterRetentionDays) {
        this.listenerConcurrency = listenerConcurrency;
        this.escalationDeadLetterTopic = escalationDeadLetterTopic;
    ...
    @Bean
    public NewTopic escalationDeadLetterTopic() {
        return TopicBuilder
                .name(escalationDeadLetterTopic)
                .partitions(1)
                .replicas(1)
                .config("retention.ms",
